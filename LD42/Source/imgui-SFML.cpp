...
ImTextureID NativeToTexID(unsigned int tex_handle) {
	__int64 handle = tex_handle;
...
void UpdateFontTexture()
{
    ...
    io.Fonts->TexID = NativeToTexID(texture.getNativeHandle());
}
...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    ImGui::Image(NativeToTexID(texture.getNativeHandle()), size, ImVec2(0, 0), ImVec2(1, 1), tintColor, borderColor);
}
    ...
    const sf::Color& tintColor, const sf::Color& borderColor)
{
    ...
    ImGui::Image(NativeToTexID(texture.getNativeHandle()), size, uv0, uv1, tintColor, borderColor);
}
                     ...
                     const sf::Color& bgColor, const sf::Color& tintColor)
{
    ...
    return ImGui::ImageButton(NativeToTexID(texture.getNativeHandle()), size, uv0, uv1, framePadding, bgColor, tintColor);
}
